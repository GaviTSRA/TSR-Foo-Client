...
public class EntityProcess extends BaseProcessor{
    ...
    public void process(RoundEnvironment env) throws Exception{
        ...
        if(round == 1){
            ...
            ObjectSet<String> nullList = ObjectSet.with("unit", "blockUnit", "player", "building"); //to-do: Change to just unit and blockUnit to match vanilla
