...
public class ConstructBlock extends Block{
    ...
    public static void breakWarning(Tile tile, Block block, Unit builder){
        ...
        if (warnBlocks.contains(block) && Time.timeSinceMillis(tile.lastBreakWarn) > 10_000) { //TO-DO: Revise this, maybe do break warns per user?
    ...
    public class ConstructBuild extends Building{
        ...
        public void blockWarning(Object config) { // TO-DO: Account for non player building stuff
            ...
            if (warnBlocks.containsKey(cblock)) {
                lastBuilder.drawBuildPlans(); // Draw their build plans TO-DO: This is kind of dumb because it only draws while they are building one of these blocks rather than drawing whenever there is one in the queue
