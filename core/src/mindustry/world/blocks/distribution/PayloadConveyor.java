...
public class PayloadConveyor extends Block{
    ...
    public class PayloadConveyorBuild extends Building{
        ...
        public void updateTile(){
            ...
            //TO-DO nondeterministic input priority
            int curStep = curStep();
            if(curStep > step){
                ...
                if(valid && stepAccepted != curStep && item != null){
                    if(next != null){
                        ...
                        //TO-DO add self to queue of next conveyor, then check if this conveyor was selected next frame - selection happens deterministically
