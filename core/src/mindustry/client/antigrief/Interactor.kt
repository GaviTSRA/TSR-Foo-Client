...
class NullUnitInteractor : UnitInteractor(Nulls.unit) {
    override val name = "null unit" // FIX-ME: Dont use this when nodes are automatically configured

    override val shortName = "null unit" // FIX-ME: Dont use this when nodes are automatically configured
}
