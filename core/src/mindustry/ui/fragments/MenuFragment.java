        ...
        if(mobile){
            ...
            parent.fill(c -> {
                ...
                c.button("", Icon.refresh, () -> {
                    Core.settings.put("updateurl", (Core.settings.getString("updateurl") + "-v6-builds").replaceFirst("((-v6|-v7)?-builds){2}", ""));
                    ui.loadfrag.show();
                    becontrol.checkUpdate(result -> {
                        ui.loadfrag.hide();
                        if(!result){
            ...
            buttons(t,
                ...
                new Buttoni("@client", Icon.wrench,
                    ...
                    new Buttoni("Github", Icon.github, () -> { // Link to client github
                        if (!Core.app.openURI("https://github.com/GaviTSRA/TSR-Foo-Client")) {
                            ui.showErrorMessage("@linkfail");
                            Core.app.setClipboardText("https://github.com/GaviTSRA/TSR-Foo-Client");
                        }
                    }),
